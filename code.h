...
#define FPUTCH(fs, ch)  fputc(ch, fs)
...
#define STREQANY3(str, str1, str2, str3)       (STREQ(str, str1) OR STREQ(str, str2) OR STREQ(str, str3))
#define STREQANY4(str, str1, str2, str3, str4)       (STREQ(str, str1) OR STREQ(str, str2) OR STREQ(str, str3))
